![channel](https://www.youtube.com/@terrsus)
...
- **Modular architecture** — each feature is isolated and hot‑swappable
- **Miniature games** — Pong, Tilt, Stratagem, and more
- **Device tools** — camera remote, program assist, BLE utilities
- **Connectivity experiments** — BLE, Wi‑Fi, sensors, and cross‑device communication
- **Wear‑native UI** — ScalingLazyColumn, ToggleChips, haptics, and round‑screen layouts
...
- Custom BLE stack
- <details><summary>Unified AppContainer DI</summary>
